	    ...
	    <div class="col-12">
			<table class="table table-hover">
			  ...
			  <tbody>
			    <tr>
			      <td>${dto.bName}</td>
			      <td><a href="notice_view.board?bId=${dto.bId}&bName=${dto.bName}&loignName=<%= session.getAttribute("member_dto_name") %>" >${dto.bTitle}</a></td>
		...
		<form id="search_form" name="search_form" action="search_notice.board" method="post">
  		<div class="row justify-content-center text-center">
  			<div class="col-10">
				...
				<button type="button" id="notice_search" class="btn btn-secondary" onclick="check_search_form()" >검색</button><br>
  			</div>
    	</div>
		</form>
    </div>	
