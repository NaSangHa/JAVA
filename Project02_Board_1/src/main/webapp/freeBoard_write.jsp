...
<body>
	...
	<div class="container">
	  ...
	  <div class="row justify-content-center text-center">
	    <div class="col-12">
	    	<form id="freeBoard_write" name="freeBoard_write" action="freeBoard_write_command.jsp" method="post" enctype="multipart/form-data">
				<table class="table col-12 justify-content-center">
				<input type="hidden" id="fbName" name="fbName" value="<%= session.getAttribute("member_dto_id") %>"/>
				  <thead class="">
				    <tr>
