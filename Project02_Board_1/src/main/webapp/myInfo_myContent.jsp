...
<body>
	...
	<div class="container">
	  <div class="row justify-content-center text-center">
	    <div class="col-12">
	      <button type="button" class="btn btn-secondary btn-lg btn-block">내가 쓴 글</button><br>
	    </div>
	  </div>
	  <div class="row justify-content-center text-center">
	    <div class="col-12">
			<table class="table table-hover">
			  ...
			  <tbody>
			    <tr>
			      <td>${dto.fbName}</td>
			      <td><a href="freeBoard_view.board?fbId=${dto.fbId}&fbName=${dto.fbName}&loginName=<%= session.getAttribute("member_dto_id") %>" >${dto.fbTitle}</a></td>
			      <td>${fn:substring(dto.fbDate, 0, 10)}</td>
			      <td>${dto.fbHit}</td>
			    </tr>
			  </tbody>
        	  </c:forEach>
