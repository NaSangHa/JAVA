	  ...
	  <div class="row justify-content-center text-center">
	    <div class="col-12">
			<table class="table table-borderless head">
			  <thead>
			    <tr class="">
			      <th class="text-center"><button type="button" class="btn  btn-lg btn-block untitle" onclick="javascript:window.location='boardManage.manage'">공지사항</button></th>
			      <th class="text-center"><button type="button" class="btn  btn-lg btn-block title" onclick="javascript:window.location='freeBoardManage.manage'">자유게시판</button></th>
			    </tr>
			  </thead>
			</table>	    	
			<hr>
			...
			<table class="table table-hover">
			  <tbody>
				<tr>
				  ...
				  <td class="col"><div id="max" class="max" style="width: ${result.max}px;">&nbsp;</div></td>
				</tr>
				<tr>
				  <td class="col-2 text-center">총 조회수</td>
				  <td class="col-1 text-center">${result.sum}</td>
				  <td class="col-7"><div id="sum" class="sum" style="width: ${result.sum}px;">&nbsp;</div></td>
				</tr>
			  </tbody>
			</table>           
			</c:forEach>
