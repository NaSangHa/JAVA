...
public class BMyContentCommand implements BCommand
{
	@Override
			...
			throws ServletException, IOException
	{
		...
		ArrayList<FreeBoard_DTO> myContent = free_board_dao.myContent(nPage, bName);
		request.setAttribute("list", myContent);
