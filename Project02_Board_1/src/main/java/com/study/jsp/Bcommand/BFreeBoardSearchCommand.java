...
public class BFreeBoardSearchCommand implements BCommand
{
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		FreeBoard_DAO board_dao = FreeBoard_DAO.getInstance();
		...
		ArrayList<FreeBoard_DTO> search_dtos = board_dao.searchNotice(nPage, search_method, search_content);
